...
public class Memory {
    ...
    {
        nodes[row][col].shown = true;
    }

    public void hideNode(int row, int col)
    {
        nodes[row][col].shown = false;
    }

    public void toggleShowNode(int row, int col)
    {
        nodes[row][col].shown = !nodes[row][col].shown;
    }
    ...
    {
        nodes[row][col].enabled = true;
    }

    public void disableNode(int row, int col)
    {
        nodes[row][col].enabled = false;
    }

    public void toggleEnabledNode(int row, int col)
    {
        nodes[row][col].enabled = !nodes[row][col].enabled;
    }
